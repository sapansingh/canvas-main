...
@Component({
  ...
  imports: [MatTableModule,
    ...
    MatNativeDateModule,
    FormsModule],
  templateUrl: './vna.component.html',
  styleUrl: './vna.component.css',
  providers: [DatePipe]
})
export class VnaComponent {
 ...
 id:number=0;
    ...
    this.id=0;
      ...
      if(this.payload.date1 == null || this.payload.date2==null){
        ...
        this.anaserv.getvna(this.payload).subscribe((res:any)=>{
